        ...
        <div class="card bg-dark text-white" style="border-radius: 1rem;">
          <div class="card-body p-5 text-center">
            ...
            <div class="mb-md-5 mt-md-4 pb-5">
              ...
              <h2 class="fw-bold mb-2">Cadastrar itens</h2>
              <p class="text-white-50 mb-5">Cadastre aqui os itens que estarão entrando em estoque:</p>
              <form action="?page=salvar" method="POST">
                ...
                <div class="form-outline form-white mb-6">
                  <input type="number" name="quantidade" class="form-control form-control-lg" required/>
                  <label class="form-label" for="quantidade">quantidade</label>
                </div>
                
                <div class="form-outline form-white mb-6">
                  <input type="text" name="destino" class="form-control form-control-lg" required/>
